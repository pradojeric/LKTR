...
<div class="container-fluid">
    ...
    <div class="card p-3">
        <form action="{{ route('roles.update', $role) }}" method="post">
                ...
                <div class="col-3">
                    @foreach($abilities as $ability)
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{ $ability->id }}" name="abilities[]" id="abilty{{$ability->id}}" @if($role->abilities->contains($ability)) checked @endif>
            ...
            <a href="{{ route('roles.show', $role) }}" class="btn btn-danger">Back</a>
